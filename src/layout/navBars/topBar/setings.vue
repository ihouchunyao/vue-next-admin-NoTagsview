		...
		<el-drawer title="布局配置" v-model="getThemeConfig.isDrawer" direction="rtl" destroy-on-close size="260px" @close="onDrawerClose">
			<el-scrollbar class="layout-breadcrumb-seting-bar">
				...
				<!-- <div class="layout-breadcrumb-seting-bar-flex">
					<div class="layout-breadcrumb-seting-bar-flex-label">primary</div> //primary 默认button按钮主题
				...
				<div class="layout-breadcrumb-seting-bar-flex mt15">
					<div class="layout-breadcrumb-seting-bar-flex-label">开启 Tagsview | 标签页</div>
					<div class="layout-breadcrumb-seting-bar-flex-value">
						<el-switch v-model="getThemeConfig.isTagsview" size="small" @change="setLocalThemeConfig"></el-switch>
					</div>
				</div>
				<div class="layout-breadcrumb-seting-bar-flex mt15">
					<div class="layout-breadcrumb-seting-bar-flex-label">开启 Tagsview | 标签页图标</div>
					<div class="layout-breadcrumb-seting-bar-flex-value">
...
const onWartermarkChange = () => {
	...
	// console.log("%c [ getThemeConfig.value.isWartermark ]", "font-size:13px; background:linear-gradient(to right , #9B63FF, #462188); color:yellow;", getThemeConfig.value.isWartermark)
	setLocalThemeConfig();
};
// 4、界面显示 --> 水印文案
