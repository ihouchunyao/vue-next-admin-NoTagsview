...
export function setFilterRouteEnd() {
	...
	console.log("%c [ filterRouteEnd ]", "font-size:13px; background:linear-gradient(to right , #9B63FF, #462188); color:yellow;", filterRouteEnd)
...
export function setFilterRoute(chil: any) {
	console.log("%c [ chil ]", "font-size:13px; background:linear-gradient(to right , #9B63FF, #462188); color:yellow;", chil)
